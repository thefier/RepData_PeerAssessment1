...
The data is loaded in a data.frame with the name of ***activity***, the Class of every column is assigned in this stage, also the scientific notation is "turn off":
...
```{r DailyActivity}
DailyActSum<-tapply(activity$steps,activity$date,sum,na.rm=T)
